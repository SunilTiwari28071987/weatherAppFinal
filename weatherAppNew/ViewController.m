...
-(void)setUpPageViewController{
    ...
    DetailedViewController *startingViewController = [self viewControllerAtIndex:self.startPage];
...
- (IBAction)startAppleWeatherApp:(id)sender {
    if(self.currentIndex != 0){
        DetailedViewController *startingViewController = [self viewControllerAtIndex:0];
        NSArray *viewControllers = @[startingViewController];
        [self.pageViewController setViewControllers:viewControllers direction:UIPageViewControllerNavigationDirectionForward animated:YES completion:nil];
    }
}
...
{
    NSUInteger index = ((DetailedViewController*) viewController).pageIndex;
...
- (DetailedViewController *)viewControllerAtIndex:(NSUInteger)index
{
    ...
    DetailedViewController *pageContentViewController = [[DetailedViewController alloc]initWithNibName:@"CityDetailedView" bundle:nil];
...
- (IBAction)stackClicked:(id)sender {
    CityListViewController *collectionVC = [[CityListViewController alloc] initWithNibName:@"CityListView" bundle:nil];
