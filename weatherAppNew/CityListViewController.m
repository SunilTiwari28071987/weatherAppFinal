...
@interface CityListViewController ()<UITableViewDataSource,UITableViewDelegate,WeatherBottomViewCell1Delegate>
...
-(void)registrNib{
    [self.collectionView registerNib:[UINib nibWithNibName:@"ListFooterView" bundle:nil] forCellReuseIdentifier:@"ListFooterView"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.row == [self.places count]){
        ListFooterView *cell = [tableView dequeueReusableCellWithIdentifier:@"ListFooterView" forIndexPath:indexPath];
        cell.delegate = self;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.row < [self.places count]){
        ...
        ViewController *viewC = [[ViewController alloc]initWithNibName:@"CityDetailedViewFooter" bundle:nil];
        viewC.startPage = indexPath.row;
...
-(void)plusClicked:(id)sender{
    SearchViewController *searchVC = [[SearchViewController alloc]initWithNibName:@"SearchView" bundle:nil];
